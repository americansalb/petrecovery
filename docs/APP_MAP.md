...
| `/geo/script` | The script game's lobby (docs/GEO.md, "Script"): read a sentence, pin where that language is spoken. Choose a pool (world, alphabets, South Asia, one shared script), rounds, timer | server layout (own share card) + client page | public | none |
