...
### WanderGuesser (geo game, 2026-09)
...
| `geo/config/route.js` | GET | WanderGuesser: which providers are set up, the Google browser key (public by design, referrer-locked), daily seed, country list. Never a server key | public; middleware 30/min | none |
