...
/**
 * ForceHubV2 - Complete redesign based on new vision
 *
 * Simple, tab-based interface:
 * - Force Header (city, divisions, stats, CTA)
...
import ForceHeaderV2 from './SquadHeaderV2';
...
export default function ForceHubV2({ initialData, forceId, isDivisionPage = false, currentDivisionId = null }) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {activeMode === 'community' && (
          <CommunityModeV2
            ...
            divisions={divisions}
            cases={allCases}
            forceName={force.name || force.cityName}
            stats={stats}
          />
        )}
      </div>
