...
/**
 * ForceTabsMobile - Mobile tab navigation
 *
 * Bottom tab bar for mobile:
 * - Cases (case queue)
 * - Map (full screen map)
 * - Force (activity panel)
 *
...
const tabs = [
  ...
  { id: 'FORCE', label: 'Force', icon: Users },
];

export default function ForceTabsMobile() {
  const { mobileTab, setMobileTab, selectedMissionId } = useForceHub();
