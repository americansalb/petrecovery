...
/**
 * MembersModal - View force members with privacy controls
 *
 * Privacy Rules:
...
export default function MembersModal({ isOpen, onClose, forceId, currentUserId, members: initialMembers, totalCount }) {
      ...
      <div className="relative w-full max-w-3xl max-h-[85vh] bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl border border-slate-700/50 flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Force Members</h2>
