...
export default function CommunityModeV2({
  ...
  return (
    <div className="space-y-6">
      {/* Community Rules/Welcome from Mascot */}
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-500/10 via-purple-400/5 to-transparent backdrop-blur-sm border border-purple-400/40 rounded-2xl p-6 shadow-lg">
        <div className="absolute top-0 right-0 w-40 h-40 bg-purple-400/10 rounded-full blur-3xl" />
        <div className="relative flex items-start gap-4">
          {/* Mascot Avatar */}
          <div className="flex-shrink-0">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-3xl border-2 border-purple-400/50 shadow-lg">
              🐾
            </div>
          </div>
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <h3 className="text-xl font-bold text-purple-200">{mascotName}</h3>
            ...
            <div className="space-y-3">
              <p className="text-slate-200 text-base leading-relaxed">
                Welcome to the {squadName || 'squad'} community! Here are our guidelines:
              </p>
              <ul className="space-y-2 text-sm text-slate-300">
                ...
                <li className="flex items-start gap-2">
                  <Shield size={16} className="text-purple-400 flex-shrink-0 mt-0.5" />
                  <span>Share helpful information and updates about lost pets</span>
                </li>
                <li className="flex items-start gap-2">
                  <Shield size={16} className="text-purple-400 flex-shrink-0 mt-0.5" />
                  <span>Report any suspicious activity to moderators</span>
                </li>
              </ul>
            </div>
          </div>
