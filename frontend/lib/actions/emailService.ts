...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || 'ReunitePets <alerts@reunitepets.org>';
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p>We're reaching out from ReunitePets.org to ask for your help. A beloved pet has gone missing in your area, and we're hoping your ${typeLabel} might be able to assist.</p>
    ...
    <p style="color: #9ca3af; font-size: 12px; margin-bottom: 0;">
      This email was sent via <a href="https://reunitepets.org" style="color: #667eea;">ReunitePets.org</a>, a free service helping reunite lost pets with their families.
    </p>
  </div>
</body>
</html>
...
We're reaching out from ReunitePets.org to ask for your help. A beloved pet has gone missing in your area.
...
---
This email was sent via ReunitePets.org
  `.trim();
}
