      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        >
          ...
          <h1 className="text-6xl md:text-7xl font-black text-white mb-6 tracking-tight">
            Meet <span className="text-amber-400">Sarama</span>
          </h1>
          <p className="text-xl text-slate-400 mb-2">(suh-RUH-mah)</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-3xl font-bold text-white">Who is Sarama?</h2>
            </div>
            <p className="text-slate-200 leading-relaxed mb-4">
              Sarama is your personal companion through one of the hardest moments a pet parent can face. Like a guardian angel, she's always by your side - offering encouragement, tracking your progress, and reminding you that you're not alone.
            </p>
            <p className="text-slate-200 leading-relaxed">
              Her name comes from ancient Sanskrit (सरमा), meaning "the fleet one." In the <strong className="text-amber-400">Rig Veda</strong>, she is the divine dog who tracked and found what was lost - a perfect symbol for our mission.
            </p>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-amber-500/10 via-orange-500/10 to-rose-500/10 border-2 border-amber-400/30 rounded-3xl p-10 mb-16"
        >
          <h2 className="text-4xl font-bold text-white mb-6 text-center">Her Ancient Origins</h2>
          <div className="max-w-3xl mx-auto text-slate-200 space-y-4 text-lg leading-relaxed">
            <p>
              In the <strong className="text-amber-400">Rig Veda</strong>, one of humanity's oldest sacred texts from the <strong className="text-amber-400">Sanatana Dharma</strong> tradition, Sarama is the divine dog: loyal, swift, and tireless.
            </p>
            <p>
            ...
            <p>
              She is celebrated as <strong className="text-amber-400">Devasuni</strong> - the divine dog - and honored as the mother of all dogs. Her story is one of devotion, determination, and the unbreakable bond between humans and their animal companions.
            </p>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-6 text-center">The Sarama Promise</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-slate-200 text-sm">
                Every lost pet deserves to come home. Sarama will remind you to keep going, even when it's hard.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-slate-200 text-sm">
                Thousands of families have walked this path. Sarama brings their wisdom to help you.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-slate-200 text-sm">
                Most lost pets ARE found. Sarama helps you focus on action, not despair.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-6">Where You'll See Sarama</h2>
          <p className="text-slate-200 text-lg mb-8 max-w-3xl mx-auto leading-relaxed">
            Look for Sarama throughout your search journey. She appears in your Mission Command Center, celebrates when you complete tasks, and pops up with helpful tips at just the right moments. Think of her as your personal cheerleader and search coordinator rolled into one.
          </p>
