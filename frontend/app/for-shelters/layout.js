...
export const metadata = buildShareMetadata({
  ...
  description:
    'Shelters and rescues run their animals on ReunitePets free, forever: a health record for every animal, automatic lost-pet matching, stray-hold tracking, adoption handoffs with full medical history, an adoption-inquiry inbox, staff seats, and your own public page.',
