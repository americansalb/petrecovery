...
export const metadata = buildShareMetadata({
  ...
  description:
    'Shelters and rescues run their animals on ReunitePets at no cost: medical records for every animal, lost-pet matching, stray-hold tracking, adoption transfers with full history, an adoption-inquiry inbox, staff accounts, and a public page.',
