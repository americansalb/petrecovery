...
/**
 * Create Rescue Force Page - Updated with ReunitePets Design System
...
const STEPS = [
  { id: 'basics', title: 'Force Basics', icon: FileText },
...
export default function CreateSquadPage() {
    ...
    switch (step) {
      case 0: // Basics
        ...
        if (formData.name.trim().length < 3) {
          setError('Force name must be at least 3 characters');
          return false;
        }
        break;
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // Redirect to the new force page
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your force's mission and what makes it special..."
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-midnight-400 mt-2">
                  This defines your force's primary coverage area for receiving case alerts
                </p>
              </div>
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-midnight-900">
                      {formData.isPublic ? 'Public Force' : 'Private Force'}
                    </span>
                  </div>
                </label>
                <p className="text-xs text-midnight-400 mt-2 ml-14">
                  {formData.isPublic
                    ? 'Anyone can find and join this force'
                    : 'Force is invite-only and hidden from search'}
                </p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-flash-100 border border-flash-200 rounded-xl">
                ...
                <p className="text-sm text-midnight-700">
                  As the force founder, you'll be able to manage members, accept cases,
                  and appoint leaders.
                </p>
              </div>
            </div>
          ...
          <div className="flex gap-3 pt-6 mt-6 border-t border-midnight-100">
            ...
            {step < STEPS.length - 1 ? (
              ...
              <Button
                ...
                className="ml-auto"
              >
                {creating ? 'Creating Force...' : 'Create Force'}
              </Button>
            )}
          </div>
        </Card>
