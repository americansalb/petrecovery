 ...
 * 1. Force Hub at /rescue-forces/[id] - city-level multi-case overview
 * 2. Mission Command Center at /cases/[missionNumber] - single case tactical page
 *
 * There should be no third "command center" route at the force level.
 * Force-level coordination happens within the Force Hub.
 * Case-level coordination happens within the Mission Command Center.
 *
 * This route is deprecated and redirects to the Force Hub.
 */
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-400">Taking you to the Force...</p>
      </div>
    </div>
  );
}
