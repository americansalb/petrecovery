...
function MetricsGrid({ metrics }) {
  const metricCards = [
    ...
    { label: 'Active Rescue Forces', value: metrics.rescue_squads_active, key: 'active_squads' },
    { label: 'Rescue Force Members', value: metrics.squad_members_total, key: 'members' },
...
const ERROR_IMPACT = {
  ...
  'squad.create_failed': { label: 'Rescue Force Creation', severity: 'high' },
  'squad.join_failed': { label: 'Rescue Force Signups', severity: 'high' },
  ...
  'squad.search_failed': { label: 'Rescue Force Search', severity: 'medium' },
  'squad.detail_failed': { label: 'Rescue Force Details', severity: 'medium' },
  ...
  'squad.leave_failed': { label: 'Rescue Force Management', severity: 'low' },
...
function getErrorImpact(eventType) {
  ...
  const prefixMap = {
    'squad': { label: 'Rescue Force Operations', severity: 'medium' },
            ...
            {result.success ? (
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs text-red-600 mt-2">
                  If this fails for valid ZIP codes, case creation or rescue force operations may be affected.
                </div>
