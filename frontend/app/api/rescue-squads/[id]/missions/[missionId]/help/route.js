...
/**
 * POST /api/rescue-squads/[id]/cases/[missionId]/help
 *
...
export async function POST(request, { params }) {
  try {
    ...
    const { id: squadId, missionId } = params;
    ...
    if (!assignment) {
      return NextResponse.json({ error: 'Case not assigned to this rescue force' }, { status: 404 });
    }
...
/**
 * DELETE /api/rescue-squads/[id]/cases/[missionId]/help
 *
