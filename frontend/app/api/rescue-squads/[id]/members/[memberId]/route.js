...
// PATCH /api/rescue-squads/[id]/members/[memberId] - Update member role
export async function PATCH(request, { params }) {
  try {
    ...
    const requesterMembership = await prisma.rescueSquadMember.findFirst({
      where: {
    ...
    const targetMember = await prisma.rescueSquadMember.findUnique({
      where: { id: memberId },
      include: {
        user: {
          select: {
    ...
    const updatedMember = await prisma.rescueSquadMember.update({
      where: { id: memberId },
      data: updateData,
      include: {
        user: {
...
// DELETE /api/rescue-squads/[id]/members/[memberId] - Remove member from squad
