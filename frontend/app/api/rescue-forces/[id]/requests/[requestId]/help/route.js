...
/**
 * POST /api/rescue-forces/[id]/requests/[requestId]/help
 *
...
export async function POST(request, { params }) {
  try {
    ...
    const { id: forceId, requestId } = params;

    // Check if user is a force member
...
/**
 * DELETE /api/rescue-forces/[id]/requests/[requestId]/help
 *
...
/**
 * PATCH /api/rescue-forces/[id]/requests/[requestId]/help
 *
