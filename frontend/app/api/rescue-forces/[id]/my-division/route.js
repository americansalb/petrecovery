...
// PATCH /api/rescue-forces/[id]/my-division - Update current user's division assignment
export async function PATCH(request, { params }) {
  try {
    ...
    // Get user's membership in this force
    ...
    // If setting a division, validate it exists and belongs to this force
    if (divisionId) {
    ...
    const updatedMembership = await prisma.rescueForceMember.update({
    ...
    await prisma.eventLog.create({
      data: {
        event_type: 'force.member_division_changed',
        ...
        metadata: JSON.stringify({
          forceId,
          forceName: updatedMembership.rescueForce.name,
          previousDivisionId,
...
// GET /api/rescue-forces/[id]/my-division - Get current user's division and available divisions
export async function GET(request, { params }) {
  try {
    ...
    // Get all available divisions in this force
