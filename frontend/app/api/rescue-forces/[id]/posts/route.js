...
export async function GET(request, { params }) {
  try {
    ...
    console.error('========================================');
    console.error('[FORCE_POSTS_GET] Error occurred');
    console.error('[FORCE_POSTS_GET] Error name:', error.name);
    console.error('[FORCE_POSTS_GET] Error message:', error.message);
    console.error('[FORCE_POSTS_GET] Error code:', error.code);
    console.error('[FORCE_POSTS_GET] Full error:', error);
    console.error('[FORCE_POSTS_GET] Stack trace:', error.stack);
    console.error('========================================');
    return NextResponse.json(
      {
...
export async function POST(request, { params }) {
  try {
    ...
    console.error('========================================');
    console.error('[FORCE_POSTS_POST] Error occurred');
    console.error('[FORCE_POSTS_POST] Error name:', error.name);
    console.error('[FORCE_POSTS_POST] Error message:', error.message);
    console.error('[FORCE_POSTS_POST] Error code:', error.code);
    console.error('[FORCE_POSTS_POST] Full error:', error);
    console.error('[FORCE_POSTS_POST] Stack trace:', error.stack);
    console.error('========================================');
    return NextResponse.json(
      {
