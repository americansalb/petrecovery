...
// GET /api/cases/[id]/assignments - Get all squad assignments for a case
...
// POST /api/cases/[id]/assignments - Squad leader accepts a case
export async function POST(request, { params }) {
  try {
    ...
    if (caseRecord.status === 'REUNITED' || caseRecord.status === 'CLOSED_OTHER') {
      return NextResponse.json(
