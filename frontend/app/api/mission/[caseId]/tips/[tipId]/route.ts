 ...
 *
 * DELETE /api/mission/[caseId]/tips/[tipId] - Dismiss a tip
 * POST /api/mission/[caseId]/tips/[tipId] - Perform tip action (e.g., post to chat)
 *
...
/**
 * DELETE /api/mission/[caseId]/tips/[tipId]
 *
 * Dismiss a Scout tip for the current user
 */
export async function DELETE(
  request: NextRequest,
  { params }: { params: Promise<{ caseId: string; tipId: string }> }
  ...
  try {
    ...
    const { caseId, tipId } = await params;
...
/**
 * POST /api/mission/[caseId]/tips/[tipId]
 *
