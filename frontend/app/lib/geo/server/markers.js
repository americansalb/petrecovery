...
export const MARKERS = {
  ...
  bho: [
    ...
    { text: 'सबहि', note: 'Everyone. Hindi writes सभी or प्रत्येक व्यक्ति, Maithili सभ.' },
    { text: 'हवे', note: 'Is, one of the Bhojpuri copulas. Hindi says है, Maithili अछि.' },
    { text: 'सकेला', note: 'Can, a present tense in one word ending in -ला. Hindi needs two words, सकता है.' },
    { text: 'आपन', note: 'Own, as in आपन धर्म, one\'s own religion. Hindi says अपना, Maithili अपन.' },
    { text: 'कौनो', note: 'Any, as in बिना कौनो भेदभाव, without any discrimination. Hindi says कोई or किसी, Maithili कोनो.' },
    { text: 'मिलल', note: 'Got, with the past ending -ल that Bhojpuri shares with Maithili. Hindi says मिला.' },
  ],
  mai: [
    ...
    { text: 'छैक', note: 'Is, in अधिकार छैक, has the right. Hindi says अधिकार है, Bhojpuri अधिकार हवे.' },
    { text: 'केँ', note: 'To, written with a nasal ँ and joined to its noun: व्यक्तिकेँ. Hindi writes व्यक्ति को, Bhojpuri के, both as separate words.' },
    { text: 'नहि', note: 'Not. Hindi writes नहीं, with a long ी and a nasal dot.' },
    { text: 'अछि', note: 'Is, the basic Maithili copula. Hindi says है, Nepali छ, Bhojpuri हवे.' },
    { text: 'केओ', note: 'Anyone, and सभ केओ is everyone. Hindi says कोई, Bhojpuri केहु.' },
    { text: 'बाक', note: 'A verbal noun in -ब plus the genitive -क: पएबाक, of getting. Hindi says पाने का, Bhojpuri पावे के.' },
  ],
  ...
  ory: [
    ...
    { text: 'ଆପଣ', note: 'You, said with respect. Bengali says আপনি and Hindi आप.' },
    { text: 'ତୁମେ', note: 'You, to a friend or an equal. Bengali says তুমি.' },
    { text: 'ମୋର', note: 'My. Bengali says আমার and Hindi मेरा.' },
    { text: 'ମାନେ', note: 'The plural ending, as in ପିଲାମାନେ, children. Bengali marks the plural with -রা.' },
    { text: 'ନାହିଁ', note: 'Not. Bengali says না and Hindi नहीं.' },
    { text: 'ନ୍ତୁ', note: 'A polite request ending, as in ଦିଅନ୍ତୁ, please give. Hindi says दीजिए.' },
  ],
  ...
  snd: [
    ...
    { text: 'آهي', note: 'Is, and the start of آهين, you are. Urdu says ہے.' },
    { text: 'ڏ', note: 'An implosive d, one of four implosive sounds Sindhi writes with letters of their own. Urdu has only د and the retroflex ڈ.' },
    { text: 'ڇا', note: 'What. Urdu says کیا, and Sindhi gives the aspirated ch its own letter, ڇ, where Urdu writes چھ.' },
  ],
  arb: [
  ...
  pbu: [
    ...
    { text: 'ټول', note: 'All. Persian and Urdu say تمام. The ring under ټ marks a retroflex t, which Urdu writes ٹ.' },
    { text: 'سره', note: 'With, placed after the noun: يو له بل سره, with one another. Persian puts با in front instead.' },
    { text: 'زه', note: 'I. Persian says من, Urdu میں.' },
    { text: 'ړ', note: 'A retroflex r with a ring below. Urdu writes ڑ and Sindhi ڙ, so the ring gives Pashto away.' },
  ],
  ckb: [
  ...
  tam: [
    ...
    { text: 'நான்', note: 'I. The dot on ன் cancels its vowel, which Tamil does where other Indian scripts stack letters. Kannada says ನಾನು.' },
    { text: 'வேண்டும்', note: 'Must, or want, after the verb. Malayalam says വേണം, Kannada ಬೇಕು.' },
    { text: 'என்று', note: 'Saying that: it closes a quote or a thought. Malayalam writes എന്ന്, Kannada ಎಂದು.' },
    { text: 'இல்லை', note: 'No, or there is not. Malayalam and Kannada say illa, without the final ai.' },
    { text: 'வில்லை', note: 'Did not: the verb runs into இல்லை, no, so தூங்கவில்லை is did not sleep.' },
    { text: 'கிற', note: 'The present tense, with the person after it: -கிறேன் I, -கிறார் he or she, -கிறது it. Malayalam uses -ുന്നു for everyone.' },
  ],
  tel: [
    { text: 'ఉ', note: 'Telugu letters hang from a tick on the top left. Kannada is the closest shape and its tick sits differently.' },
    { text: 'తాగాను', note: 'I drank: a past verb ending in -ను means I did it. Kannada, the script this one gets mistaken for, ends the same verb -ದೆ.' },
    { text: 'నేను', note: 'I. Kannada says ನಾನು and Tamil நான்.' },
    { text: 'నువ్వు', note: 'You, to a friend or a child. Kannada says ನೀನು and Tamil நீ.' },
    { text: 'దయచేసి', note: 'Please. Kannada says ದಯವಿಟ್ಟು and Tamil தயவுசெய்து.' },
    { text: 'గురించి', note: 'About, placed after its noun. Kannada says ಬಗ್ಗೆ and Tamil பற்றி.' },
    { text: 'నుండి', note: 'From, placed after the noun. Tamil says இருந்து; Kannada adds the ending -ಇಂದ.' },
    { text: 'ఎక్కువ', note: 'More, or a lot. Kannada says ಹೆಚ್ಚು and Tamil அதிகம்.' },
    { text: 'తాడు', note: 'He does: -తాడు puts a man in the verb, as in వెళ్తాడు, he goes. Kannada ends it -ತ್ತಾನೆ.' },
  ],
  kan: [
  ...
  sin: [
    ...
    { text: 'නවා', note: 'The everyday present tense, as in යනවා, goes. Spoken Sinhala uses this one ending for I, you, he and they.' },
    { text: 'ඔබ', note: 'You, the polite form used in writing. Friends say ඔයා.' },
    { text: 'මට', note: 'To me. Sinhala puts the one who wants or needs in this form: මට ඕන, I want.' },
    { text: 'නෑ', note: 'No, or isn’t, in everyday speech. Written Sinhala says නැත.' },
    { text: 'හැම', note: 'Every, as in හැම දාම, every day. The hook ැ is the vowel of English cat, which Sinhala has its own letters for.' },
    { text: 'සමඟ', note: 'With. Its last letter ඟ is an n and a g said as one sound, which Indian scripts spell with two letters.' },
  ],
  ...
  amh: [
    ...
    { text: 'እያንዳንዱ', note: 'Each, as in እያንዳንዱ ሰው, everyone. Tigrinya says ሕድሕድ ሰብ.' },
    { text: 'ሰው', note: 'Person. Tigrinya says ሰብ, ending in ብ where Amharic has ው.' },
    { text: 'መብት', note: 'A right. Tigrinya uses another word, መሰል.' },
    { text: 'ነው', note: 'Is, closing the sentence. Tigrinya says እዩ.' },
    { text: 'ወይም', note: 'Or. Tigrinya shortens it to ወይ.' },
    { text: 'አገር', note: 'Country. Tigrinya writes ሃገር, starting with ሃ.' },
  ],
  tir: [
  ...
  tha: [
    { text: 'ฉัน', note: 'I. Thai and Lao look alike; Thai keeps more Sanskrit spelling and so more silent letters.' },
    { text: 'เดิน', note: 'To walk. Thai writes five tones with four marks and no spaces between words.' },
    { text: 'ทุกคน', note: 'Everyone: ทุก every, คน person. Thai writes no vowel in คน; Lao spells it ຄົນ, with a vowel sign on top.' },
    { text: 'สิทธิ', note: 'A right. Thai keeps the Pali spelling but says just sit; Lao writes it the way it sounds, ສິດ.' },
    { text: 'บุคคล', note: 'A person, a Pali word. Thai keeps the double ค and a final ล said as n; Lao writes ບຸກຄົນ, as it sounds.' },
    { text: 'ไม่ได้', note: 'Cannot, or may not. ไม่ is Thai for not; Lao uses another word, ບໍ່, as in ບໍ່ໄດ້.' },
    { text: 'หรือ', note: 'Or, spelled with ร, an r. Lao writes ຫຼື, with a small l tucked under the first letter.' },
    { text: 'ประเทศ', note: 'Country. Thai ends it with ศ, a Sanskrit letter said as t; Lao writes ປະເທດ.' },
  ],
  ...
  hrv: [
    ...
    { text: 'Svatko', note: 'Everyone. Bosnian and Serbian write svako, without the t, and Slovene says vsakdo.' },
    { text: 'Nitko', note: 'No one. Bosnian and Serbian write niko, and Slovene says nihče.' },
    { text: 'uhićenju', note: 'Arrest. Bosnian and Serbian use another word, hapšenje.' },
    { text: 'sudjelovati', note: 'To take part, an infinitive straight after pravo. Bosnian writes da sudjeluje and Serbian da učestvuje.' },
    { text: 'skrb', note: 'Care. Bosnian says briga and Serbian staranje, while Slovene shares skrb.' },
    { text: 'vjerojatno', note: 'Probably; nevjerojatno is unlikely. Serbian writes verovatno and Bosnian vjerovatno.' },
  ],
  lit: [
  ...
  tur: [
    { text: 'ğ', note: 'A soft g. Turkish leaves it silent and lengthens the vowel before it; Azerbaijani writes the same letter but says it. Uzbek writes gʻ instead.' },
    ...
    { text: 'değil', note: 'Not, is not. Azerbaijani writes deyil.' },
    { text: 'olacağım', note: 'I will be. Azerbaijani ends the same future in -am: olacağam.' },
    { text: 'haizdir', note: 'Has, holds, a legal word from Arabic. Azerbaijani says malikdir and Uzbek egadir.' },
    { text: 'verilemez', note: 'Cannot be given, with the cannot ending fused onto the verb. Azerbaijani writes verilə bilməz, as two words.' },
    { text: 'veya', note: 'Or. Azerbaijani writes və ya, as two words.' },
    { text: 'kimse', note: 'Anyone; hiç kimse is no one. Azerbaijani says heç kim and Uzbek hech kim.' },
    { text: 'maliktir', note: 'Has, possesses. Azerbaijani writes malikdir: Turkish turns the d into t after k.' },
    { text: 'Herkes', note: 'Everyone. Azerbaijani writes hər kəs, as two words.' },
  ],
  azj: [
    ...
    { text: 'hüquq', note: 'Right, a loan from Arabic. Uzbek spells it huquq, with no ü, and Turkish says hak.' },
    { text: 'şəxs', note: 'Person. Turkish writes şahıs, Turkmen şahs and Uzbek shaxs.' },
    { text: 'Heç', note: 'No, none: heç kim is no one. Turkish writes hiç kimse and Uzbek hech kim.' },
    { text: 'bilməz', note: 'Cannot, with bil- as a separate helper verb. Turkish joins the ending onto the verb, as in tutuklanamaz.' },
    { text: 'malikdir', note: 'Has, possesses. Turkish writes maliktir, turning the d into t after k.' },
    { text: 'azadlıq', note: 'Freedom. Turkmen writes azatlyk, Turkish hürriyet and Uzbek erkinlik.' },
    { text: 'üçün', note: 'For. Turkish writes için, Turkmen üçin and Uzbek uchun.' },
    { text: 'kimi', note: 'Like, as. Turkish says gibi and Uzbek kabi.' },
  ],
  uzn: [
    ...
    { text: 'huquq', note: 'Right, a loan from Arabic. Azerbaijani spells it hüquq, with ü, and Turkish says hak.' },
    { text: 'egadir', note: 'Has, is the owner of. Azerbaijani says malikdir and Turkish haizdir.' },
    { text: 'Hech', note: 'No, none: hech kim is no one. Turkish writes hiç kimse and Azerbaijani heç kim.' },
    { text: 'mumkin emas', note: 'Cannot, literally is not possible. Turkish builds this into the verb instead, as in edilemez.' },
    { text: 'inson', note: 'Person. Turkish and Azerbaijani write insan, where Uzbek has o for the long a of the Arabic word.' },
    { text: 'oʻ', note: 'Oʻ, a letter of its own with a turned comma. In oʻz, self, Azerbaijani and Turkmen write öz.' },
    { text: 'yaxshi', note: 'Good, well. Azerbaijani writes yaxşı and Turkish says iyi.' },
  ],
  vie: [
  ...
  yor: [
    ...
    { text: 'è̩tó̩', note: 'Right, as in human rights. Igbo says ikike and Hausa hakki.' },
    { text: 'kò̩ò̩kan', note: 'Each single one, as in everyone. Igbo says onye ọ bụla and Hausa kowane mutum.' },
    { text: 'gbo̩dò̩', note: 'Must; after kò it means must not. Igbo opens the same ban with ọ dịghị onye, and Hausa with ba wanda.' },
    { text: 'òmìnira', note: 'Freedom. Hausa says \'yanci.' },
    { text: 'ènìyàn', note: 'Person, people. Igbo says mmadụ and Hausa mutum.' },
    { text: 'àti', note: 'And, joining nouns. Igbo says na and Hausa da.' },
  ],
  som: [
  ...
  zul: [
    ...
    { text: 'umuntu', note: 'Person. Xhosa writes umntu, without the middle u, and Swati umuntfu.' },
    { text: 'Akekho', note: 'No one. Xhosa says akukho namnye and Swati kute umuntfu.' },
    { text: 'futhi', note: 'And, also. Swati writes futsi and Xhosa says kwaye.' },
    { text: 'sithunzi', note: 'Dignity, isithunzi. Xhosa says isidima and Swati spells it sitfunti.' },
    { text: 'mphakathi', note: 'Society, the community, as in umphakathi. Swati writes umphakatsi and Xhosa says uluntu.' },
  ],
