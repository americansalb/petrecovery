 ...
 *
 * Route: /pets/[id]/today
 * The ONE place anyone taps "done": med doses (checklist, week strip,
 * offline outbox) and care routines together. Management and history
 * live in the Health Book; nothing here is reference material.
 */
...
import {
  Plus, Check, X, Undo2, PartyPopper, Sun, Sunset, Moon, Loader2, CalendarDays, Sparkles, CloudOff, Info,
} from 'lucide-react';
...
export default function TodayPage() {
  ...
  // CARE-kind rows belong to the pet profile's good-stuff section;
  // this page is purely medical
