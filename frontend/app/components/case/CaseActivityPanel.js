...
/**
 * Case Activity Panel - Right side of Command Center
 *
 * Shows:
...
export default function CaseActivityPanel({ caseData, userRole, currentUserId, onUpdate }) {
  ...
  const buildTimeline = () => {
    ...
    if (caseData?.createdAt) {
      timeline.push({
        id: 'created',
        type: 'system',
        content: `Case #${caseData.caseNumber} created`,
    ...
    if (caseData?._count?.sightings > 0) {
