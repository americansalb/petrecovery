...
export { regionAround, MAPKIT_WORLD_PX } from '../lib/mapRegion';
      ...
      if (r.answer && (r.answerMarker ?? true)) {
        answers.push(
          new mapkit.MarkerAnnotation(coordinate(r.answer), {
            color: '#22c55e',
            // A number only where there are several to tell apart. On a
            // single reveal every answer was "1", whichever round it was.
            glyphText: r.answerLabel || r.label || (rounds ? String(i + 1) : undefined),
