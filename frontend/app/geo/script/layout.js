...
export const metadata = buildShareMetadata({
  ...
  description:
    'Read a sentence, pin where that language is spoken. 91 languages across 25 writing systems, scored by distance rather than by country, so Tamil and Marathi are different answers.',
  index: false,
});
