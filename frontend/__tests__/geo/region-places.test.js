...
const PLACES = {
  ...
  mon: [[47.89, 106.91, 'Ulaanbaatar'], [49.03, 104.08, 'Erdenet']],
  ...
  azj: [[40.41, 49.87, 'Baku'], [40.68, 46.36, 'Ganja']],
  ...
  run: [[-3.38, 29.36, 'Bujumbura'], [-3.43, 29.93, 'Gitega']],
  // Central, East and Southern Africa.
  lua: [[-6.15, 23.6, 'Mbuji-Mayi'], [-5.9, 22.42, 'Kananga']],
  kng: [[-6.27, 14.24, 'M\'banza-Kongo'], [-5.82, 13.46, 'Matadi']],
  kmb: [[-9.54, 16.34, 'Malanje'], [-9.3, 14.91, 'N\'dalatando']],
  umb: [[-12.78, 15.74, 'Huambo'], [-12.38, 16.93, 'Kuito']],
  cjk: [[-9.66, 20.39, 'Saurimo'], [-7.38, 20.83, 'Dundo']],
  lue: [[-13.54, 23.1, 'Zambezi'], [-11.78, 19.92, 'Luena']],
  lun: [[-11.74, 24.43, 'Mwinilunga']],
  kqn: [[-12.17, 26.39, 'Solwezi'], [-13.46, 25.83, 'Kasempa']],
  bem: [[-10.21, 31.18, 'Kasama'], [-12.8, 28.21, 'Kitwe']],
  toi: [[-16.81, 26.99, 'Choma'], [-16.28, 27.48, 'Monze']],
  loz: [[-15.25, 23.13, 'Mongu'], [-17.5, 24.27, 'Katima Mulilo']],
  ndo: [[-17.91, 15.98, 'Ondangwa'], [-17.79, 15.7, 'Oshakati']],
  sag: [[4.39, 18.56, 'Bangui'], [5.76, 20.67, 'Bambari']],
  suk: [[-2.52, 32.9, 'Mwanza'], [-3.66, 33.42, 'Shinyanga']],
  nym: [[-5.02, 32.8, 'Tabora'], [-4.21, 33.18, 'Nzega']],
  nyn: [[-0.61, 30.66, 'Mbarara'], [-0.54, 30.19, 'Bushenyi']],
  vmw: [[-15.12, 39.27, 'Nampula'], [-14.54, 40.67, 'Nacala']],
  kde: [[-10.95, 39.28, 'Newala'], [-11.66, 39.55, 'Mueda']],
  yao: [[-14.48, 35.26, 'Mangochi'], [-13.31, 35.24, 'Lichinga']],
  nso: [[-23.9, 29.45, 'Polokwane'], [-24.3, 29.56, 'Lebowakgomo']],
  tso: [[-25.05, 33.64, 'Xai-Xai'], [-23.3, 30.72, 'Giyani']],
  ssw: [[-26.31, 31.14, 'Mbabane'], [-26.49, 31.38, 'Manzini']],
  ven: [[-22.95, 30.48, 'Thohoyandou'], [-23.04, 29.9, 'Makhado']],
  // West Africa.
  pcm: [[5.52, 5.75, 'Warri'], [6.52, 3.37, 'Lagos']],
  kri: [[8.48, -13.23, 'Freetown'], [7.96, -11.74, 'Bo']],
  kea: [[14.93, -23.51, 'Praia'], [16.89, -24.98, 'Mindelo']],
  ewe: [[6.6, 0.47, 'Ho'], [6.13, 1.22, 'Lomé']],
  fon: [[7.18, 1.99, 'Abomey'], [6.37, 2.43, 'Cotonou']],
  gaa: [[5.56, -0.2, 'Accra'], [5.67, -0.02, 'Tema']],
  ada: [[6.1, -0.02, 'Somanya'], [5.79, 0.63, 'Ada Foah']],
  bci: [[7.69, -5.03, 'Bouaké'], [6.82, -5.28, 'Yamoussoukro']],
  nzi: [[4.87, -2.24, 'Axim'], [5.05, -2.88, 'Half Assini']],
  mos: [[12.37, -1.52, 'Ouagadougou'], [13.58, -2.42, 'Ouahigouya']],
  dag: [[9.4, -0.84, 'Tamale'], [9.44, -0.01, 'Yendi']],
  tiv: [[7.73, 8.54, 'Makurdi'], [7.32, 9, 'Gboko']],
  ibb: [[5.04, 7.93, 'Uyo'], [5.18, 7.71, 'Ikot Ekpene']],
  bin: [[6.34, 5.62, 'Benin City']],
  sus: [[9.55, -13.67, 'Conakry'], [10.06, -12.87, 'Kindia']],
  emk: [[10.39, -9.31, 'Kankan'], [11.42, -9.17, 'Siguiri']],
  snk: [[14.45, -11.44, 'Kayes'], [15.16, -12.18, 'Sélibaby']],
  men: [[7.96, -11.74, 'Bo'], [7.88, -11.19, 'Kenema']],
  tem: [[8.88, -12.04, 'Makeni'], [8.77, -12.79, 'Port Loko']],
  srr: [[14.34, -16.41, 'Fatick'], [14.17, -16.85, 'Joal-Fadiouth']],
  dyo: [[12.81, -16.23, 'Bignona'], [12.58, -16.27, 'Ziguinchor']],
  fuc: [[15.66, -13.26, 'Matam'], [12.89, -14.94, 'Kolda']],
  // South-East Asia, north-east India and the Pacific.
  mad: [[-7.16, 113.48, 'Pamekasan'], [-7.01, 113.86, 'Sumenep']],
  min: [[-0.95, 100.35, 'Padang'], [-0.31, 100.37, 'Bukittinggi']],
  ban: [[-8.65, 115.22, 'Denpasar'], [-8.12, 115.1, 'Singaraja']],
  bug: [[-4.54, 120.33, 'Watampone'], [-4.02, 119.63, 'Parepare']],
  ace: [[5.55, 95.32, 'Banda Aceh'], [5.18, 97.15, 'Lhokseumawe']],
  iba: [[1.24, 111.46, 'Sri Aman'], [2.02, 112.93, 'Kapit']],
  hil: [[10.72, 122.56, 'Iloilo City'], [10.68, 122.95, 'Bacolod']],
  war: [[11.24, 125, 'Tacloban'], [11.78, 124.88, 'Catbalogan']],
  pam: [[15.03, 120.69, 'San Fernando'], [15.15, 120.59, 'Angeles']],
  bcl: [[13.62, 123.19, 'Naga'], [13.14, 123.74, 'Legazpi']],
  pag: [[16.02, 120.23, 'Lingayen'], [16.04, 120.33, 'Dagupan']],
  kha: [[25.57, 91.88, 'Shillong'], [25.45, 92.2, 'Jowai']],
  lus: [[23.73, 92.72, 'Aizawl'], [22.88, 92.73, 'Lunglei']],
  cnh: [[22.64, 93.61, 'Hakha'], [22.7, 93.43, 'Thantlang']],
  tah: [[-17.54, -149.57, 'Papeete'], [-16.74, -151.45, 'Uturoa']],
  rar: [[-21.21, -159.78, 'Avarua']],
  niu: [[-19.06, -169.92, 'Alofi']],
  cha: [[13.48, 144.75, 'Hagatna'], [15.18, 145.75, 'Saipan']],
  mah: [[7.1, 171.37, 'Majuro']],
  pau: [[7.345, 134.485, 'Koror'], [7.485, 134.625, 'Melekeok']],
  bis: [[-17.73, 168.32, 'Port Vila'], [-15.51, 167.18, 'Luganville']],
  // Regional Europe and the Americas.
  nds: [[53.55, 9.99, 'Hamburg'], [54.32, 10.13, 'Kiel']],
  sco: [[55.95, -3.19, 'Edinburgh'], [57.15, -2.09, 'Aberdeen']],
  vec: [[45.44, 12.33, 'Venice'], [45.41, 11.88, 'Padua']],
  wln: [[50.63, 5.57, 'Liège'], [50.47, 4.87, 'Namur']],
  cos: [[41.94, 8.78, 'Ajaccio'], [42.7, 9.45, 'Bastia']],
  gag: [[46.3, 28.66, 'Comrat'], [46.06, 28.83, 'Ceadîr-Lunga']],
  lim: [[50.85, 5.69, 'Maastricht'], [51.37, 6.17, 'Venlo']],
  scn: [[38.12, 13.36, 'Palermo'], [37.5, 15.09, 'Catania']],
  nap: [[40.85, 14.27, 'Naples'], [40.68, 14.77, 'Salerno']],
  lij: [[44.41, 8.93, 'Genoa'], [44.32, 8.46, 'Savona']],
  pms: [[45.07, 7.69, 'Turin'], [44.9, 8.21, 'Asti']],
  frr: [[54.62, 8.97, 'Bredstedt'], [54.79, 8.83, 'Niebüll']],
  dsb: [[51.76, 14.33, 'Cottbus'], [51.94, 13.9, 'Lübben']],
  csb: [[54.33, 18.2, 'Kartuzy'], [54.12, 17.98, 'Kościerzyna']],
  szl: [[50.26, 19.02, 'Katowice'], [50.67, 17.93, 'Opole']],
  yua: [[20.97, -89.62, 'Mérida'], [20.69, -88.2, 'Valladolid']],
  quc: [[15.03, -91.15, 'Santa Cruz del Quiché'], [14.91, -91.36, 'Totonicapán']],
  cak: [[14.66, -90.82, 'Chimaltenango'], [14.77, -91.18, 'Sololá']],
  kek: [[15.47, -90.37, 'Cobán'], [15.53, -89.34, 'El Estor']],
  mam: [[15.51, -91.6, 'Todos Santos Cuchumatán'], [14.96, -91.8, 'San Marcos']],
  tzh: [[16.91, -92.09, 'Ocosingo'], [16.78, -92.35, 'Oxchuc']],
  nav: [[35.68, -109.05, 'Window Rock'], [36.79, -108.69, 'Shiprock']],
  arn: [[-38.74, -72.6, 'Temuco'], [-39.28, -72.23, 'Villarrica']],
  cab: [[16.97, -88.22, 'Dangriga'], [15.76, -86.79, 'La Ceiba']],
  // Russia and the Caucasus.
  tyv: [[51.72, 94.45, 'Kyzyl'], [51.28, 91.58, 'Chadan']],
  alt: [[51.96, 85.96, 'Gorno-Altaysk'], [50.75, 86.14, 'Ongudai']],
  kjh: [[53.13, 90.52, 'Askiz'], [52.8, 89.9, 'Tashtyp']],
  mhr: [[56.63, 47.89, 'Yoshkar-Ola'], [56.43, 48.98, 'Morki']],
  udm: [[56.85, 53.21, 'Izhevsk'], [58.14, 52.66, 'Glazov']],
  kpv: [[61.67, 50.84, 'Syktyvkar'], [65.01, 53.91, 'Izhma']],
  myv: [[54.18, 45.18, 'Saransk'], [54.85, 46.24, 'Ardatov']],
  xal: [[46.31, 44.26, 'Elista'], [46.17, 45.34, 'Yashkul']],
  kbd: [[43.49, 43.62, 'Nalchik'], [43.68, 43.53, 'Baksan']],
  ady: [[44.61, 40.1, 'Maykop'], [44.88, 39.19, 'Adygeysk']],
  ava: [[42.54, 46.7, 'Khunzakh'], [42.98, 47.5, 'Makhachkala']],
  lez: [[41.46, 47.74, 'Akhty'], [41.67, 48.15, 'Kasumkent']],
  krc: [[43.77, 41.91, 'Karachayevsk'], [43.4, 42.92, 'Tyrnyauz']],
  kum: [[42.82, 47.12, 'Buynaksk'], [42.71, 47.57, 'Karabudakhkent']],
};
