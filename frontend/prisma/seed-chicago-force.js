 ...
 * - Test activities
 *
 * Run with: npx prisma db execute --file prisma/seed-chicago-force.js
 * Or: node prisma/seed-chicago-force.js
 */
...
async function main() {
  ...
  // Create test users for the force
  const testUsers = [
  ...
  // ============================================================================
  // CREATE HELP REQUESTS (ForceTask with type REQUEST)
  // ============================================================================
